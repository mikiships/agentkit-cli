# All-Day Build Contract: agentkit-cli v1.28.0 release completion
...
- [ ] Create or verify annotated tag `v1.28.0` on the intended release commit.
...
Publish `agentkit-cli==1.28.0` to PyPI and verify both project and version endpoints plus artifacts.
...
- [ ] Publish only the `1.28.0` wheel and sdist.
- [ ] Verify PyPI project JSON and version JSON both report `1.28.0` live.
...
- If blocked, write `blocker-report-v1.28.0-release.md` with exact failure, attempts, and recommended next move.
