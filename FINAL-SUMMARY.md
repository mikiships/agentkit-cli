...
- The shipped tag is `v1.22.0` -> `2c2b89f`, while `origin/feat/v1.22.0-spec` later advanced to a later docs-only chronology head.
...
- Branch/tag: `origin/feat/v1.22.0-spec` exists on origin at a later docs-only chronology head; annotated tag `v1.22.0` exists on origin and peels to shipped release commit `2c2b89f`.
