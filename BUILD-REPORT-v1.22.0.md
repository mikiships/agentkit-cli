...
- Branch and tag proof: `origin/feat/v1.22.0-spec` is at docs-only chronology head `471958c`, while annotated tag `v1.22.0` peels to shipped release commit `2c2b89f`
...
- The branch later advanced to docs-only chronology head `471958c` after the release tag and publish were already complete.
