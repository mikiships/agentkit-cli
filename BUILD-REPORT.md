...
| D4 | ✅ Complete | Reconciled repo and workspace chronology so the shipped tag truth stays separate from the later docs-only branch head `471958c`. |
...
- Git surface: `origin/feat/v1.22.0-spec` now points to docs-only chronology head `471958c`, annotated tag `v1.22.0` exists on origin, and `v1.22.0^{}` peels to shipped release commit `2c2b89f`
...
- The release branch later advanced to docs-only chronology head `471958c` after release gating notes were committed.
