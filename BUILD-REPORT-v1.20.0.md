# BUILD-REPORT-v1.20.0.md — agentkit-cli v1.20.0 land lanes
...
- Branch proof: `git ls-remote --heads origin feat/v1.20.0-land-lanes` -> current docs-only chronology head on `origin/feat/v1.20.0-land-lanes`, which is later than the shipped tag commit `5baec07b5fb2f2be35559edbef2a10081b850910`
...
- The current branch head is a later docs-only chronology commit on `origin/feat/v1.20.0-land-lanes`.
