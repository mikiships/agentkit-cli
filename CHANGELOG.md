...
### Docs
- README, BUILD-REPORT, and progress log updated for the shipped v1.2.0 contracts release, explicitly separating the shipped tag/PyPI commit from the later docs-only branch-head reconciliation commit.
