...
_NAV = """<header>
  ...
  <nav>
    ...
    <a href="{base_url}trending.html">Daily Trending</a>
    <a href="{base_url}#org-leaderboard">Org Leaderboard</a>
    {topic_links}
...
agentkit contract --init</code></pre>
        ...
        <section class="trending-section" id="daily-trending">
          <div class="container">
            <h2 class="section-title">Daily Trending</h2>
            <p class="section-note">See which trending GitHub repos score highest for agent-readiness today.</p>
            <a class="btn-gh" href="trending.html">View Daily Trending ↗</a>
            <div class="feature-card pages-trending" style="margin-top:1rem">
              <h3>Daily Trending Repos</h3>
              <p>Track agent-readiness scores for today's trending repositories.</p>
              <pre class="code-block"><code>agentkit daily-duel --pages</code></pre>
            </div>
          </div>
        </section>

        <!-- Org Leaderboard section -->
        <section class="org-leaderboard-section" id="org-leaderboard">
          <div class="container">
            <h2 class="section-title">Org Leaderboard</h2>
            <p class="section-note">Score all public repos in any GitHub org and rank them by agent-readiness.</p>
            <a class="btn-gh" href="leaderboard.html">View Leaderboard ↗</a>
          </div>
        </section>

        <!-- Developer Profile Card section -->
        <section class="user-scorecard-section" id="user-scorecard">
          <div class="container">
            <h2 class="section-title">Developer Profile Card</h2>
            <p class="section-note">Grade any developer's public repos for agent-readiness with a shareable profile card.</p>
        ...
        <section class="subscribe-section">
          <div class="container">
            ...
            <p>Watch the <a href="https://github.com/mikiships/agentkit-cli">GitHub repo</a> for new releases and features.</p>
          </div>
        </section>
