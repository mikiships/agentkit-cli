...
from agentkit_cli.reconcile import ReconcileEngine, ReconcileError
...
def reconcile_command(
    ...
    try:
        ...
        plan = engine.build(project, launch_path=launch_path)
    except (FileNotFoundError, ReconcileError, ValueError) as exc:
    ...
    if output_dir is not None:
        ...
        typer.echo(f"Wrote reconcile directory: {written}")
    typer.echo(rendered)
