...
def relaunch_command(
    ...
    try:
        ...
        plan = engine.build(project, resume_path=resume_path, packet_dir=packet_dir or output_dir)
    except (FileNotFoundError, RelaunchError, ValueError) as exc:
    ...
    if output_dir is not None:
        ...
        typer.echo(f"Wrote relaunch directory: {written}")
    typer.echo(rendered)
