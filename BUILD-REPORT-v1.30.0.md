...
- Release-critical validation from the current tree is green: source-audit ready, flagship spec now emits `flagship-adjacent-closeout-advance`, and the focused slice passed `32` tests.
- Full-suite proof from the pre-release planner closeout still applies to the pre-edit release candidate head `341ea50504a8734756a7bf144a2507e67d82fef7`: `5020 passed, 1 warning in 202.30s`. Re-run after release-surface edits if any behavior-affecting contradiction appears.
